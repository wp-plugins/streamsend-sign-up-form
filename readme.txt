...
Tags: streamsend, esp, form, plugin
...
Quickly and easily add highly customizable sign-up forms to your WordPress website. 
...
1. Upload `streamsend-plugin.php` to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Place the shortcode [streamsend form=FORMID]
